...
<body>  
  ...
  <aside>
    <nav class="admin-nav">
     <ul class="nav-link1">
      <li><a href="#"><i class="fa-solid fa-bars"></i>
        </a></li>
    ...
    <div class="left-dashboard ">
      <ul>
        <li class="list-icons">
         ...
         <li>
          <a href="#"><i class="nav-icon fas fa-chalkboard"></i><p>Manage Syllabus</p>
        ...
        <li>
         ...
         <li>
           <a href="#"><i class="nav-icon fas fa-money-check"></i><p>Fee Details </p>
           <i class="fas fa-angle-left right arrow "></i></a>
         </li>
         <li>
         ...
         <li>
           <a href="#"><i class="nav-icon fas fa-users"></i><p>Communications</p>
           <i class="fas fa-angle-left right arrow "></i></a>
         </li>
       </ul>
    </div>
      ...
      <div class="content-row">
        <div class="student content-info">
          ...
          <div class="student-info">
           <span class="info-box">Total Students</span>
       ...
       <div class="teachers content-info">
         <div class="teacher-icons"><span><i class="fas fa-users"></i></span></div>
         <div class="teacher-info">
           <span class="info-box">Total Teachers</span>
        ...
        <div class="course content-info">
          ...
          <div class="course-info">
            <span class="info-box">Total Courses</span>
        ...
        <div class="in-question content-info">
...
<!-- footer sections -->
  ...
  <div class="admin-footer">
    <strong>Copyright © 2024<a href="#">School Managment System</a></strong>
    All rights reserved.
    
  </div>
  <!-- here add is script files -->
